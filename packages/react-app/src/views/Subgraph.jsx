  ...
  return (
      <>
          ...
          <div style={{width:780, margin: "auto", paddingBottom:64}}>
            ...
            {data?<Table dataSource={data.properties} columns={purposeColumns} rowKey={"id"} />:<Typography>{(loading?"Loading...":deployWarning)}</Typography>}
